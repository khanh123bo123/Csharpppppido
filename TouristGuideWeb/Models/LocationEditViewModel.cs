...
public class LocationEditViewModel
{
    ...
    [Required(ErrorMessage = "Mo ta audio khong duoc de trong")]
    [RegularExpression(@"^(?!\s*$).+", ErrorMessage = "Mo ta audio khong duoc chi chua khoang trang")]
    [StringLength(4000, ErrorMessage = "Mo ta audio khong duoc vuot qua 4000 ky tu")]
